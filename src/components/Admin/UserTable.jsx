...
//                     <span className={`inline-flex items-center gap-1 px-2 py-1 rounded-full text-xs ${getStatusColor(user.status)}`}>
...
//                       className="bg-emerald-600 hover:bg-emerald-700 px-2 py-1 rounded text-white flex items-center gap-1"
//                     >
//                       <Eye className="h-4 w-4" /> Edit
//                     </button>
//                     <button
//                       onClick={() => setDeleteUser(user)}
//                       className="bg-red-600 hover:bg-red-700 px-2 py-1 rounded text-white flex items-center gap-1"
//                     >
